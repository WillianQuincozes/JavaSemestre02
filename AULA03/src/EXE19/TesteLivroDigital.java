...
public class TesteLivroDigital {
    public static void main(String[] args) {
        ...
        System.out.println("Digite o título do livro digital: ");
        String titulo = sc.nextLine();
        System.out.println("Digite o autor do livro digital: ");
        String autor = sc.nextLine();
        System.out.println("Digite o tamanho do arquivo do livro digital (em MB): ");
